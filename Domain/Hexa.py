...
class Hexa(object):
    ...
    def __init__(self):
        ...
        self.front_left = Leg(name=LegName.FRONT_LEFT, coxa=0, femur=1, tibia=2, front=[140], back=[25], left=[], right=[], rest=[100])
        ...
        self.front_right = Leg(name=LegName.FRONT_RIGHT, coxa=9, femur=10, tibia=11, front=[40], back=[130], left=[], right=[], rest=[70])
